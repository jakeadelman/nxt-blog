...
function (_React$Component) {
  ...
  _createClass(BlogContent, [{
    ...
    value: function componentDidMount() {
      this.fetchPosts(this.props.id).then(this.setPosts).then(this.fetchImg(this.state.posts.fields.heroImage.sys.id).then(function (res) {
...
//# sourceMappingURL=blogpage.js.54b2e383e733a85f2bc4.hot-update.js.map