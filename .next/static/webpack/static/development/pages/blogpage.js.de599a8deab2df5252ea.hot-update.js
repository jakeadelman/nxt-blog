...
function (_React$Component) {
  ...
  function BlogContent(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setPosts", function (response) {
      ...
      console.log(response.items[0].fields.body);
      preFormatBody = response.items[0].fields.body;
      ...
      console.log(_this.state.markdown); // return response.fields.heroImage.sys.id;
    });
...
//# sourceMappingURL=blogpage.js.de599a8deab2df5252ea.hot-update.js.map