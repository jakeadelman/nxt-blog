...
function (_React$Component) {
  ...
  _createClass(BlogContent, [{
    ...
    value: function componentDidMount() {
      this.fetchPosts(this.props.id).then(this.setPosts); // this.fetchImg(this.props.id).then(res => console.log(res));
...
//# sourceMappingURL=blogpage.js.7ebc7c4db06de5c4bc2f.hot-update.js.map