...
function (_React$Component) {
  ...
  function BlogContent(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setPosts", function (response) {
      ...
      var heroImg = asset[0].fields.file;
      console.log(asset);
      console.log(response.items[0]); // return response.fields.heroImage.sys.id;
    });
...
//# sourceMappingURL=blogpage.js.91348cc342c57cb5618a.hot-update.js.map