...
function (_React$Component) {
  ...
  function BlogContent(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "fetchPosts", function (entry) {
      return _this.client.getEntries(entry);
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setPosts", function (response) {
      ...
      _this.setState({
        posts: response,
        markdown: marked(res) // heroImage: response.fields.heroImage.sys.id

      });

      console.log(response); // return response.fields.heroImage.sys.id;
    });
...
//# sourceMappingURL=blogpage.js.0f4848783e06e0d43cef.hot-update.js.map