...
function (_React$Component) {
  ...
  _createClass(BlogContent, [{
    ...
    value: function componentDidMount() {
      ...
      this.fetchPosts(this.props.id).then(this.setPosts).then(function (response) {
        return _this2.fetchImg(response).then(_this2.setImg);
      });
...
//# sourceMappingURL=blogpage.js.933e1a4c1b176970c979.hot-update.js.map