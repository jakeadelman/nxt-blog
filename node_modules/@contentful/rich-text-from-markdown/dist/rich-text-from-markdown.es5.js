...
function definition(eat, value, silent) {
  ...
  while (index < length) {
    ...
    if (character !== space$b && character !== tab$b) {
      break
    }
  ...
  while (index < length) {
    ...
    if (character !== tab$b && character !== space$b && character !== lineFeed$c) {
      break
    }
  ...
  if (!test) {
    ...
    while (index < length) {
      ...
      if (character === lineFeed$c) {
        ...
        if (character === lineFeed$c || character === test) {
          return
        }
  ...
  if (!character || character === lineFeed$c) {
    if (silent) {
      return true
    }
...
function table(eat, value, silent) {
  ...
  while (index < length) {
    lineIndex = value.indexOf(lineFeed$d, index);
  ...
  subvalue = lines.join(lineFeed$d);
...
function paragraph(eat, value, silent) {
  ...
  var index = value.indexOf(lineFeed$e);
  var length = value.length;
  var position;
  var subvalue;
  var character;
  ...
  while (index < length) {
    ...
    if (value.charAt(index + 1) === lineFeed$e) {
      break
    }
    ...
    if (commonmark) {
      ...
      if (size >= tabSize$4 && character !== lineFeed$e) {
        index = value.indexOf(lineFeed$e, index + 1);
        continue
      }
    }
...
function link$1(eat, value, silent) {
  ...
  if (character === lessThan$5) {
    ...
    while (index < length) {
      ...
      if (commonmark && character === lineFeed$g) {
        return
      }
...
function reference(eat, value, silent) {
  ...
  if (type === footnote && content.indexOf(space$e) !== -1) {
    return eat(subvalue)({
      type: footnote,
...
var markdownNodeTypes = new Map([
    ['paragraph', richTextTypes_es5_2.PARAGRAPH],
    ['heading', 'heading'],
    ['text', 'text'],
    ['emphasis', 'text'],
    ['strong', 'text'],
    ['delete', 'text'],
    ['inlineCode', 'text'],
    ['link', richTextTypes_es5_3.HYPERLINK],
    ['thematicBreak', richTextTypes_es5_2.HR],
    ['blockquote', richTextTypes_es5_2.QUOTE],
    ['list', 'list'],
    ['listItem', richTextTypes_es5_2.LIST_ITEM],
]);
...
var nodeContainerTypes = new Map([
    ['delete', 'block'],
    [richTextTypes_es5_2.HEADING_1, 'block'],
    [richTextTypes_es5_2.HEADING_2, 'block'],
    [richTextTypes_es5_2.HEADING_3, 'block'],
    [richTextTypes_es5_2.HEADING_4, 'block'],
    [richTextTypes_es5_2.HEADING_5, 'block'],
    [richTextTypes_es5_2.HEADING_6, 'block'],
    [richTextTypes_es5_2.LIST_ITEM, 'block'],
    [richTextTypes_es5_2.UL_LIST, 'block'],
    [richTextTypes_es5_2.OL_LIST, 'block'],
    [richTextTypes_es5_2.QUOTE, 'block'],
    [richTextTypes_es5_2.HR, 'block'],
    [richTextTypes_es5_2.PARAGRAPH, 'block'],
    [richTextTypes_es5_3.HYPERLINK, 'inline'],
    ['text', 'text'],
    ['emphasis', 'text'],
    ['strong', 'text'],
    ['inlineCode', 'text'],
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                content = (_a.sent());
                hyperlink = {
                    nodeType: richTextTypes_es5_3.HYPERLINK,
                    data: { uri: node.url },
                    content: content,
                };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                content = _a.sent();
                return [2 /*return*/, {
                        nodeType: richTextTypes_es5_2.DOCUMENT,
                        data: {},
                        content: content,
                    }];
        }
